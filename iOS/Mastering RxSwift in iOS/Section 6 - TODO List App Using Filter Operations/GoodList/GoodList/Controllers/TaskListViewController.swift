...
class TaskListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        guard let navigation = segue.destination as? UINavigationController,
            let addTaskViewController = navigation.viewControllers.first as? AddTaskViewController else {
        ...
        addTaskViewController.taskSubjectObservable
            ...
            var exixstingTasks = self.tasks.value
            exixstingTasks.append(task)
            self.tasks.accept(exixstingTasks)
