...
//    }
  ...
  Widget texteAvecStyle(String data, {color: Colors.black, fontSize: 17.0}) {
    if(Platform.isIOS) {
  ...
  Widget body() {
    return new SingleChildScrollView(
      ...
      child: new Column(
        ...
        children: <Widget>[
          padding(),
          texteAvecStyle('Remplissez tous les champs pour connaître votre besoin journalier en calories'),
          padding(),
          new Container(
            ...
            return new CupertinoAlertDialog(
                ...
                actions: <Widget>[
                  new CupertinoButton(
                    ...
                    child: texteAvecStyle('OK', color: Colors.pink),
                  )
                ]
            );
          } else {
